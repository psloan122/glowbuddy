    ...
    return (
      <div className="bg-cream min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-pulse">
          {/* Hero skeleton */}
          <div className="bg-white py-10 md:py-14 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 mb-6 min-h-[200px]" style={{ borderBottom: '3px solid #F0EBE6' }}>
          ...
          <div className="h-48 sm:h-64 bg-gray-100 rounded-xl mb-6" />
          {/* Price card skeleton */}
