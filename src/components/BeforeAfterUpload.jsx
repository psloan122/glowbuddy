...
export default function BeforeAfterUpload({ providerId, onUploadComplete, onRemove }) {
      ...
      <div>
        <div className="grid grid-cols-2 gap-3">
          <div className="relative">
            <img src={beforeUrl} alt="Before" className="w-full h-32 object-cover rounded-xl" loading="lazy" width={300} height={128} />
            <span className="absolute bottom-1 left-1 text-[10px] font-medium bg-black/50 text-white px-1.5 py-0.5 rounded">Before</span>
          </div>
          <div className="relative">
            <img src={afterUrl} alt="After" className="w-full h-32 object-cover rounded-xl" loading="lazy" width={300} height={128} />
  ...
  function DropZone({ type, label, fileRef, url }) {
    ...
    if (url) {
      return (
        <div className="relative">
          <img src={url} alt={label} className="w-full h-32 object-cover rounded-xl" loading="lazy" width={300} height={128} />
