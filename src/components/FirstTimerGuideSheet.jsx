...
export default function FirstTimerGuideSheet({ treatmentName, onClose, onActivateMode }) {
  ...
  return (
    <>
      ...
      <div className="fixed z-[85] bottom-0 left-0 right-0 max-h-[85dvh] rounded-t-2xl bg-white overflow-y-auto md:left-auto md:right-0 md:top-0 md:bottom-0 md:w-[440px] md:max-h-full md:rounded-t-none md:rounded-l-2xl shadow-2xl" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
        {/* Mobile handle */}
