    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-xl text-center">
        ...
        <h2 className="text-xl font-bold text-text-primary mb-2">
          You've seen 3 prices
        </h2>
        <p className="text-sm text-text-secondary mb-6">
          Share yours to unlock the full GlowBuddy database.
        </p>
        ...
        <div className="flex flex-col gap-3">
          <Link
            ...
            className="w-full py-3 bg-rose-accent text-white font-medium rounded-xl hover:bg-rose-dark transition-colors text-center"
          >
            Log My Treatment
          </Link>
