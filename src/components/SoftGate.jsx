...
export default function SoftGate({ onUnlock, city }) {
  ...
  return (
    <div className="col-span-full glow-card p-8 text-center" style={{ backgroundColor: '#FDF6F0' }}>
      ...
      <h2 className="text-xl font-bold text-text-primary mb-2">
        {city ? `23 more prices near ${city}` : 'Unlock the full database'}
      </h2>
