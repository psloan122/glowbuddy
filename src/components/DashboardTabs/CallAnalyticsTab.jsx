...
/**
 * Provider dashboard tab: call analytics showing Know Before You Glow-generated calls.
 */
export default function CallAnalyticsTab({ providerId }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-lg font-bold text-text-primary mb-1">Calls Generated by Know Before You Glow</h2>
      ...
      {totalCalls === 0 && (
        <div className="text-center py-8 text-text-secondary">
          ...
          <p className="text-sm">No calls recorded yet. Once patients start calling through Know Before You Glow, you'll see your analytics here.</p>
        </div>
      )}
    </div>
  );
