        ...
        <Container style={{ maxWidth: 560, margin: '0 auto' }}>
          ...
          <Section style={{ backgroundColor: CARD_BG, borderRadius: 16, padding: '40px 32px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            ...
            <Section style={{ textAlign: 'center' as const, marginTop: 24 }}>
              <Button href="https://knowbeforeyouglow.com" style={{ backgroundColor: ACCENT, color: '#fff', borderRadius: 999, padding: '14px 32px', fontSize: 16, fontWeight: 600, textDecoration: 'none' }}>
                Browse Prices
              </Button>
            </Section>
          </Section>
